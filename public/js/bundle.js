...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * just a kickoff file. we can reach into our source proper from here.
	 */
	...
	Context.init(); // *** es6 style, but 'main_scss' is superfluous
	//require( "main.scss" ); // *** cjs style, kind of makes more sense for this..?
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../tools/node_modules/css-loader/index.js!./../../tools/node_modules/sass-loader/index.js!./main.scss", function() {
				var newContent = require("!!./../../tools/node_modules/css-loader/index.js!./../../tools/node_modules/sass-loader/index.js!./main.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactView = __webpack_require__(7);
	...
	/**
	 * this module isn't available in the global scope, which we are happy about, and contains everything thereafter, amen.
	 */
	
	var reactView = new _ReactView2.default();
	
	function init() {
	    console.log("/Context/ -init 290416");
	    reactView.init();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// *** i'm currently favouring old style js 'class' over es6 classes...
	function ReactView() {
	    ...
	    var init = function init() {
	        console.log("/ReactView/ -init ", props.el);
	
	        var ReactElement = _react2.default.createClass({
	            ...
	            render: function render() {
	                return _react2.default.createElement(
	                    "div",
	                    { className: "wangdangdoodle" },
	                    "React thang a lang from adjacent 'client' project 290416"
	                );
	            }
	        });
	
	        _reactDom2.default.render(_react2.default.createElement(ReactElement, null), props.el);
	    };
